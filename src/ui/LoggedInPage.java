...
public class LoggedInPage extends JFrame {
	...
	private void initializeUI() {		
		...
		// Listens for changes in search box. If that happens, this will call 
		// the searchAndSortLeftPanel()
		...
		// Launches the JFrame in which you can add item details
		addBtn.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				JFrame loggedinPageJFrame = LoggedInPage.this;
	...
	private void updateRightPanel(ItemDetails item) {
		...
		// Logic for dynamic changes of toggle icons and password visibility and for
		// copying item values
		...
		// Launches the EditItePage.java JFrame in which you can edit the item details
